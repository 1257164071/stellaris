...
Morris.Donut({
    element: 'graph-donut',
    data: [
        {value: 70, label: '部门预算比例', formatted: 'at least 70%'},
        {value: 15, label: '部门预算比例', formatted: 'approx. 15%'},
        {value: 10, label: '部门预算比例', formatted: 'approx. 10%'},
        {value: 5, label: '部门预算比例', formatted: 'at most 5%'}
    ],
    backgroundColor: '#fff',
    labelColor: '#1fb5ac',
    colors: [
